...
public class StreamOperator {
    ...
    /**
     * peek使用：对流中元素进行遍历操作，与forEach类似，但不会销毁流元素 ->打印
     */
    @Test
    public void peek() {
        list.stream()
                ...
                // peek
                .peek(sku -> System.out.println("peek操作:"+sku.getSkuName()))
    ...
    /**
     * sort使用：对流中元素进行排序，可选则自然排序或指定排序规则。有状态操作  ->价格降序
     */
    @Test
